...
public class SuperAdminController {
	...
	@RequestMapping(value = "/soucoinmanage", method = RequestMethod.GET)
	private String soucoinmanage() {
		// 搜币管理页
		return "superadmin/soucoinmanage";
	}

	@RequestMapping(value = "/collectmanage", method = RequestMethod.GET)
	public String collectmanage(@RequestParam Integer shopId) {
		return "superadmin/collectmanage";
	}

	@RequestMapping(value = "/servicecollectmanage", method = RequestMethod.GET)
	public String servicecollectmanage(@RequestParam Integer serviceId) {
		return "superadmin/servicecollectmanage";
	}
